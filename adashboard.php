...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="adashboard.php">Dashboard <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div class="container my-4 card">
 ...
 <div class="card-footer">
   <br>
 <button class="button"><a href="schedule.php">Schedule Interview</a></button>
    <button class="button"><a href="video.php">Video Interview</a></button>
    <br><br>
    <button class="button"><a href="performance.php">Performance Form</a></button>
