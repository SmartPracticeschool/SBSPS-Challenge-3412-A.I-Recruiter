  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="index.php">Instructions <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<br>
  ...
  <ol class="card-body">
    ...
    <ol class="card-body">
        ...
        <li>Click on the "exam information "link from the left </li>
        <li>When ready to begin, click on the ______________ link to open the exam   </li>
      <ul>
          <li> Do not begin until you are absolutely ready to start!</li>
          <li><strong>the exam must be started between time on day ,month date and time</strong></li>
         </ul>
          <ol>
